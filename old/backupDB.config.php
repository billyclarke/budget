...
define('ADMIN_EMAIL', 'andrewjshults@gmail.com'); // eg: admin@example.com
...
define('DB_HOST', (isset($_REQUEST['DB_HOST']) ? $_REQUEST['DB_HOST'] : 'localhost')); // usually 'localhost'
define('DB_USER', (isset($_REQUEST['DB_USER']) ? $_REQUEST['DB_USER'] : 'speceven_budget'));  // MySQL username
define('DB_PASS', (isset($_REQUEST['DB_PASS']) ? $_REQUEST['DB_PASS'] : '7XyPJ8mqrmt3'));  // MySQL password
...
if (!empty($_REQUEST['onlyDB'])) {
	...
	define('DB_NAME', 'speceven_budget');
}
...
$backupabsolutepath = dirname(__FILE__).'/backupdb/'; // make sure to include trailing slash
